<template>
    <div class="FooterMusic">
        <div class="footerLeft" @click="updateDetailShow">
            ...
            <van-popup v-model:show="datailShow" position="right" :style="{ height: '100%' ,width:'100%'}">
...
export default {
  ...
  computed:{
      ...mapState(['playList','playListIndex','isbtnShow','datailShow'])
  },
  components:{
      MusicDetail
  },
  ...
  watch:{
      playListIndex(){//如果下标发生了改变 就自动播放音乐
